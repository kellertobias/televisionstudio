...
import { iModules, AtemModule, ObsModule, SleepModule, TextgenModule, AudioModule, SystemStateModule } from '../modules';
...
export class Engine {
    ...
    constructor() {
        this.config = new ConfigBackend(
            ...
            process.env.SHOWDATA_PATH ? process.env.SHOWDATA_PATH : './config/flashdrives',
        )
        ...
        this.interfaces = {
            desk: {
                web: new DeskWebInterface(this.config, this.modules, this.macros, this.servers.web.server),
